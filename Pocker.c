...
static int show_fs() {
  // isolate filesystem
system("dd if=/dev/zero of=/home/virtualizationLab/fs.img bs=1M count=4096");

system("losetup /dev/loop16 /home/virtualizationLab/fs.img");
system("mkfs.ext4 /home/virtualizationLab/fs.img");
...
show_net();
show_fs();
//creation of new control group for controlling process CPU availability:
